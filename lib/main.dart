...
void main() async {
  try {
    Trekko trekko = await LoginBuilder("http://localhost:8080", "realAccount1@web.de", "1aA!hklj32r4hkjl324ra").build();
    runApp(TrekkoApp(trekko: trekko));
  } catch (e) {
    if (e is BuildException) {
      if (e.reason == LoginResult.failedNoSuchUser) {
        try {
          runApp(TrekkoApp(trekko: await RegistrationBuilder("http://localhost:8080", "realAccount1@web.de", "1aA!hklj32r4hkjl324ra", "1aA!hklj32r4hkjl324ra", "12345").build()));
        } catch (e) {
