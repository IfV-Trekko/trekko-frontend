...
class QuestionTilesBuilder {
  ...
  static List<CupertinoListTile> buildQuestionTiles({
    ...
    Future<void> showSelectPicker({
      ...
      List<Widget> optionsWidgets = question.options!.map((option) => Center(
    ...
    in profile.preferences.onboardingQuestions) {
      ...
      if (question.type == QuestionType.boolean) {
      ...
      } else if (question.type == QuestionType.select) { //TODO: Answer parsing
        questionTile = CupertinoListTile.notched(
          padding: padding,
          title: Text(question.title,
              style: AppThemeTextStyles.normal),
        ...
        questionTile = CupertinoListTile.notched(
          ...
          trailing: const CupertinoListTileChevron(),
          onTap: () => navigateAndEditText(profile, question,
                  (String newValue) {
                profile.preferences.setQuestionAnswer(question.key,
                    newValue);
              }),
